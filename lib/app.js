...
const teamArray = []
//presents questions for additional team members and creates a new Intern/Engineer object using that info
const newTeamMember = () => {
    return inquirer 
        .prompt({
            type: 'list',
...
//presents questions for manager info and creates a new manager object using that info
const managerPrompt = () => {
...
//creates a new file and saves to specified folder
